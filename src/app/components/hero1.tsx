...
const Hero1 = () => {
  return (
    <div>
        <h2  className="font-bold text-[25px] text-center mt-[40px] text-blue-900">Certified Cloud Applied Generative AI Engineer (GenEng) and Solopreneur <br /> Developing Billion-Dollar Valued Developers and Solopreneurs</h2>
